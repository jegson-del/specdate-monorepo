...
return [
    ...
    'laravel' => [
        ...
        'add_routes' => filter_var(env('SCRIBE_ADD_ROUTES', env('APP_ENV') === 'local'), FILTER_VALIDATE_BOOL),
    ...
    'auth' => [
        ...
        // Optional: set SCRIBE_AUTH_KEY in your .env to a real "Bearer <token>" value
        // if you want Scribe to make authenticated response calls.
